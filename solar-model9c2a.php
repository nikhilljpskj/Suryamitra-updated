...
<head>
      ...
      <meta name="keywords" content="Solar, Rooftop, PV, Power Plant, SPV, Solar panel, Ground Mounted, EPC, Jharkhand, No. 1,Polycrystalline, Monocrystalline, Half Cut, Mono Perc, Bifacial, Glass to Glass,BIPV, Inverters, Battery, Waaree, UTL, FLIN, CAPEX, BOOT, DISCOM">
      <meta name="description" content="CAPEX - Capital Expenditure Solar Model explains the Plant owner has himself to finance and do the funding and is free to sell his excess energy to DISCOM">
...
<meta property="og:image" content="/img/SMIPL.jpeg">
      <title>CAPEX / BOOT solar model | SuryaMitra Renewables Pvt. Ltd.</title>
      <!-- Stylesheets -->
      <link href="https://suryamitra.co.in/solar-model9c2a.php?product=CAPEX-BOOT-solar-model" rel="canonical">
      ...
      <section class="page-banner style-two" style="background-image:url(images/main-slider/11.jpg);">
         <div class="auto-container">
            <div class="inner-container clearfix">
               <h1>CAPEX / BOOT solar model</h1>
               <ul class="bread-crumb clearfix">
                  <li><a href="index.php">Home</a></li>
                  <li><a href="#">Products & Solutions</a></li>                 
                  <li>CAPEX / BOOT solar model</li>                 
               </ul>
            </div>
         </div>
      </section>
                  ...
                  <div class="services-detail">
                     <div class="inner-box">                       
                        <div class="lower-content">
                           <!-- Title Box -->
                           <div class="title-box">
                              <h2>CAPEX / BOOT solar model</h2>
                           </div>                           
                           
                           
                                                     <div class="text wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                           <p>In this model, the entire investment comes from the power consumer, consumer generally hire a solar EPC company who provide turnkey installation of entire solar power system and hand over assets to consumers. EPC also do annual operation and maintained (O&amp;M) of plant on mutually agreed cost per annum.</p>
                           </div>
                                                    	<div class="col-md-12">
                               <div class="image wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">
                                 <img src="utility/products/1569231147capex-model.png" alt="CAPEX / BOOT solar model" title="CAPEX / BOOT solar model"/>
                               </div>
                            </div>
                                                  </div>  
                        <div class="lower-content">
...
<!-- Mirrored from www.mecpower.in/solar-model?product=CAPEX-BOOT-solar-model by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Aug 2020 10:03:18 GMT -->
</html>