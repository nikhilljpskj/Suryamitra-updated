...
<head>
      ...
      <meta name="description" content="In the OPEX model, an investor or project developer invests the CAPEX and consumer pays for the energy consumed.">
      ...
      <title>OPEX / RESCO solar model | SuryaMitra Renewables Pvt. Ltd.</title>
      <!-- Stylesheets -->
      <link href="https://suryamitra.co.in/solar-modelb1de.php?product=OPEX-RESCO-solar-model" rel="canonical">
      ...
      <section class="page-banner style-two" style="background-image:url(images/main-slider/11.jpg);">
         <div class="auto-container">
            <div class="inner-container clearfix">
               <h1>OPEX / RESCO solar model</h1>
               <ul class="bread-crumb clearfix">
                  <li><a href="index.php">Home</a></li>
                  <li><a href="#">Products & Solutions</a></li>                 
                  <li>OPEX / RESCO solar model</li>                 
               </ul>
            </div>
         </div>
      </section>
                  ...
                  <div class="services-detail">
                     <div class="inner-box">                       
                        <div class="lower-content">
                           <!-- Title Box -->
                           <div class="title-box">
                              <h2>OPEX / RESCO solar model</h2>
                           </div>                           
                           
                           
                                                     <div class="text wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                           <p>In the OPEX model, an investor or project developer (sometimes called Renewable Energy Service Company &ndash;RESCO) invests the CAPEX and consumer pays for the energy consumed/supplied by the solar power project delicately developed for a particular consumer. Both consumer and developer sign a long-term power purchase agreement (PPA) for an agreed tenure &amp; tariff.</p>
                           </div>
                                                    	<div class="col-md-12">
                               <div class="image wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">
                                 <img src="utility/products/1569231242resco-model.png" alt="OPEX / RESCO solar model" title="OPEX / RESCO solar model"/>
                               </div>
                            </div>
                                                  </div>  
                        <div class="lower-content">
...
<!-- Mirrored from www.mecpower.in/solar-model?product=OPEX-RESCO-solar-model by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Aug 2020 10:03:21 GMT -->
</html>